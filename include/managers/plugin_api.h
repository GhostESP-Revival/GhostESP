...
/* Raw panel touch, sampled by the input task. Feeds the touch fields of
 * input_snapshot_ex() so a canvas app can clear its own held buttons on
 * finger-up even if the release never reaches it. */
