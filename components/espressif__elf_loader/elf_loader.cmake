...
macro(project_so project_name)
    if(NOT CONFIG_ELF_DYNAMIC_LOAD_SHARED_OBJECT)
        message(WARNING "CONFIG_ELF_DYNAMIC_LOAD_SHARED_OBJECT is not set; building .so without runtime loader support. The .so will not be loadable by the firmware unless this option is also enabled in the consuming firmware's sdkconfig.")
    endif()
