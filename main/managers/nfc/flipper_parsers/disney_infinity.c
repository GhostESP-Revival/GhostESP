...
static bool disney_infinity_parse(const NfcDevice* device, FuriString* parsed_data) {
    ...
    do {
        ...
        // Basic output without name lookup for now
        furi_string_printf(parsed_data, "Disney Infinity\nValid Disney Infinity tag\n");
...
const NfcSupportedCardsPlugin disney_infinity_plugin = {
