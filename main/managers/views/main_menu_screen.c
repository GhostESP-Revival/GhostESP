...
static const char *menu_item_label(const menu_item_t *item) {
    if (strcmp(item->name, "WiFi") == 0) return i18n_text(I18N_KEY_WIFI);
    if (strcmp(item->name, "BLE") == 0) return i18n_text(I18N_KEY_BLE);
    if (strcmp(item->name, "GPS") == 0) return i18n_text(I18N_KEY_GPS);
    if (strcmp(item->name, "Infrared") == 0) return i18n_text(I18N_KEY_INFRARED);
    if (strcmp(item->name, "NFC") == 0) return i18n_text(I18N_KEY_NFC);
    if (strcmp(item->name, "NRF24") == 0) return i18n_text(I18N_KEY_NRF24);
    if (strcmp(item->name, "SubGHz") == 0) return i18n_text(I18N_KEY_SUBGHZ);
    if (strcmp(item->name, "BadUSB") == 0) return i18n_text(I18N_KEY_BADUSB);
    if (strcmp(item->name, "GhostLink") == 0) return i18n_text(I18N_KEY_GHOSTLINK);
    if (strcmp(item->name, "Apps") == 0) return i18n_text(I18N_KEY_APPS);
    if (strcmp(item->name, "Settings") == 0) return i18n_text(I18N_KEY_SETTINGS);
    return item->name;
}
...
static void carousel_fade_out_ready_cb(lv_anim_t *a) {
    ...
    const char *new_label = menu_item_label(&menu_items[menu_index]);
...
static void update_menu_item(bool slide_left) {
    ...
    if (LV_HOR_RES > 150) {
        ...
        lv_label_set_text(label, menu_item_label(&menu_items[menu_index]));
    ...
    carousel_cache.label_text = menu_item_label(&menu_items[menu_index]);
...
static void handle_menu_item_selection(int item_index) {
    ...
    const char *name = menu_item_label(&menu_items[menu_index]);
