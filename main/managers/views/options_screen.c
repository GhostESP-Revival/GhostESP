...
static const char *settings_item_label(const SettingsItem *item) {
    if (!item) return "";
    switch ((SettingsType)item->setting_type) {
        case SETTING_DISPLAY_TIMEOUT: return i18n_text(I18N_KEY_DISPLAY_TIMEOUT);
        case SETTING_MAX_BRIGHTNESS: return i18n_text(I18N_KEY_MAX_BRIGHTNESS);
        case SETTING_INVERT_COLORS: return i18n_text(I18N_KEY_INVERT_COLORS);
        case SETTING_MENU_THEME: return i18n_text(I18N_KEY_MENU_THEME);
        case SETTING_MENU_LAYOUT: return i18n_text(I18N_KEY_MENU_LAYOUT);
        case SETTING_ZEBRA_MENUS: return i18n_text(I18N_KEY_ZEBRA_MENUS);
        case SETTING_MENU_BG_SHADE: return i18n_text(I18N_KEY_BG_SHADE);
        case SETTING_MENU_ROUNDED: return i18n_text(I18N_KEY_ROUNDED_MENUS);
        case SETTING_MENU_ITEM_BORDERS: return i18n_text(I18N_KEY_ITEM_BORDERS);
        case SETTING_TERMINAL_COLOR: return i18n_text(I18N_KEY_TERMINAL_COLOR);
        case SETTING_LANGUAGE: return i18n_text(I18N_KEY_LANGUAGE);
        case SETTING_RGB_MODE: return i18n_text(I18N_KEY_RGB_MODE);
        case SETTING_NEOPIXEL_BRIGHTNESS: return i18n_text(I18N_KEY_NEOPIXEL_BRIGHTNESS);
        case SETTING_NAV_BUTTONS: return i18n_text(I18N_KEY_NAVIGATION_BUTTONS);
        case SETTING_THIRD_CONTROL: return i18n_text(I18N_KEY_THIRD_CONTROL);
        case SETTING_WEB_AUTH: return i18n_text(I18N_KEY_WEB_AUTH);
        case SETTING_AP_ENABLED: return i18n_text(I18N_KEY_AP_ENABLED);
        case SETTING_WEBUI_AP_ONLY: return i18n_text(I18N_KEY_WEBUI_AP_ONLY);
        case SETTING_POWER_SAVE: return i18n_text(I18N_KEY_POWER_SAVING_MODE);
        case SETTING_USB_HOST_MODE: return i18n_text(I18N_KEY_USB_HOST_MODE);
        case SETTING_AUTO_SAVE_SCANS: return i18n_text(I18N_KEY_AUTO_SAVE_SCANS);
        case SETTING_RUN_SETUP_WIZARD: return i18n_text(I18N_KEY_RUN_SETUP_WIZARD);
        case SETTING_I2C_SCAN: return i18n_text(I18N_KEY_I2C_BUS_SCAN);
        case SETTING_EXPORT_SETTINGS_SD: return i18n_text(I18N_KEY_EXPORT_SETTINGS_SD);
        case SETTING_IMPORT_SETTINGS_SD: return i18n_text(I18N_KEY_IMPORT_SETTINGS_SD);
        case SETTING_FACTORY_RESET: return i18n_text(I18N_KEY_FACTORY_RESET);
        case SETTING_WIGLE_AUTO_UPLOAD: return i18n_text(I18N_KEY_AUTO_UPLOAD);
        case SETTING_WIGLE_DONATE: return i18n_text(I18N_KEY_DONATE_DATA);
        case SETTING_LOAD_CONFIG: return i18n_text(I18N_KEY_LOAD_CONFIG_FROM_SD);
        case SETTING_WIGLE_TEST_API: return i18n_text(I18N_KEY_TEST_API_KEY);
        case SETTING_WIGLE_HELP: return i18n_text(I18N_KEY_HELP);
        case SETTING_WIGLE_MANUAL_UPLOAD: return i18n_text(I18N_KEY_MANUAL_UPLOAD);
        case SETTING_WIGLE_STATS: return i18n_text(I18N_KEY_VIEW_WIGLE_STATS);
        case SETTING_MIC_VISUALIZER_MODE: return i18n_text(I18N_KEY_VISUALIZER_MODE);
        case SETTING_MIC_COLOR_MODE: return i18n_text(I18N_KEY_COLOR_MODE);
        case SETTING_MIC_SENSITIVITY: return i18n_text(I18N_KEY_SENSITIVITY);
        case SETTING_MIC_SMOOTHING: return i18n_text(I18N_KEY_SMOOTHING);
        case SETTING_MIC_CONTRAST: return i18n_text(I18N_KEY_CONTRAST);
        case SETTING_MIC_MIRROR_MODE: return i18n_text(I18N_KEY_MIRROR_MODE);
        case SETTING_MIC_CALIBRATE: return i18n_text(I18N_KEY_CALIBRATE);
        case SETTING_GHOSTLINK_SPLIT_VIEW: return i18n_text(I18N_KEY_SPLIT_TERMINAL);
...
static const char * const language_options[] = {"English", "Hindi"};
...
static SettingsItem settings_items[] = {
    ...
    {"Language", SETTING_LANGUAGE, language_options, 2, 0, SETTINGS_CAT_THEME_ASSETS, false, NULL, SETTING_WIDGET_VALUE_CYCLE},
    ...
    for (int i = 0; i < sizeof(settings_items)/sizeof(settings_items[0]); i++) {
        switch (settings_items[i].setting_type) {
            ...
            case SETTING_LANGUAGE:
                settings_items[i].current_value = settings_get_ui_language(&G_Settings);
                break;
...
static void settings_refresh_row_label(int setting_index) {
    ...
    for (uint32_t row_idx = 0; row_idx < child_cnt; row_idx++) {
        ...
        if (label) {
            char buf[128];
            snprintf(buf, sizeof(buf), "%s: %s", settings_item_label(item), settings_item_value_text(item));
                    ...
                    if (settings_items[i].category_id == category_id) {
                        if (current_item_in_category >= build_item_index) {
                            ...
                            if (item->widget == SETTING_WIDGET_TOGGLE) {
                                ...
                                btn = options_view_add_item(g_options_view, settings_item_label(item), option_event_cb, (void *)(intptr_t)i);
                                if (!btn) break;
